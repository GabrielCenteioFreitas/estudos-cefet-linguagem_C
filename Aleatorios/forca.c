...
int main() {
  ...
  while (erros < 6 && strchr(letras_acertadas, '_') != NULL) {
    ...
    verificarLetraNaPalavra(pedirLetra(), letras_palavra, letras_acertadas, letras_erradas, erros);
